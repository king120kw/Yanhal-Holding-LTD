...
export default function RestorationSlider() {
  ...
  return (
    <section className="bg-charcoal border-t border-white/5 overflow-hidden">
      {/* ── Text Strip ─────────────────────────────────── */}
      <div className="max-w-7xl mx-auto px-6 sm:px-10 pt-20 sm:pt-32 pb-12 sm:pb-16
                      grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-end">
        <div className="space-y-6">
          <span className="text-primary font-display text-[9px] sm:text-[10px] tracking-[0.5em] uppercase leading-none block">
            RESTORATION SERIES
          </span>
          <h3 className="font-display text-4xl sm:text-6xl text-white tracking-tighter leading-[0.95] uppercase">
            THE ART OF <br />
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 gap-8 border-t border-white/10 pt-8">
            <div className="flex flex-col gap-3">
              ...
              <div>
                <p className="text-[9px] font-display text-white/30 tracking-widest mb-1 leading-none uppercase">
                  The Heritage
                </p>
                <p className="text-sm font-medium text-white">Legacy State</p>
              </div>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-white">Modernist Estate</p>
              </div>
            </div>
          </div>

          <p className="text-[9px] font-display text-primary/50 tracking-[0.4em] uppercase">
            {yearDisplay}
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 24px rgba(197,160,89,0.7)",
            willChange: "left",
          }}
        />
        ...
        <div
          ...
          className="absolute top-1/2 z-20 flex items-center justify-center
                     w-14 h-14 rounded-full bg-primary text-black shadow-2xl
        ...
        <div className="absolute bottom-6 right-6 text-[9px] px-3 py-1.5 bg-primary
                        text-black tracking-[0.3em] font-display uppercase font-bold
                        pointer-events-none">
          New Vision
        </div>
        ...
        <div className="absolute top-6 left-1/2 -translate-x-1/2 text-[8px] px-4 py-1.5
                        bg-black/60 text-white/60 tracking-[0.3em] font-display uppercase
                        pointer-events-none whitespace-nowrap backdrop-blur-sm border border-white/10">
          ← Drag to Compare →
        </div>
